...
const ar: Dict = {
  ...
  "home.eyebrow": "الوكيل الموثوق لمنتجات آبل في السودان",
  "home.title.a": "المعيار",
  "home.title.b": "الجديد.",
  "home.p1": "مستوردة مباشرة من قنوات دولية موثوقة. كل جهاز آيفون يشمل ضمان Blue Apple لمدة سنة كاملة ودعم فني محلي في الخرطوم.",
  "home.p2": "تأسست Blue Apple عام 2021 كخدمة وساطة للهواتف. اليوم نعمل كوجهة السودان المتميزة لأجهزة آبل الأصلية والتقنية اليومية.",
  "home.p3": "نحن لا نبيع هواتف فقط — بل نبني الثقة.",
  "home.cta.shop": "تسوق المخزون",
  "home.cta.service": "مركز الخدمة",
  "home.phones.eyebrow": "آيفون",
  "home.phones.title": "آيفون",
  "home.phones.highlight": "من الجيل ١٣ إلى ١٧",
  "home.phones.desc": "مواصفات دولية، مفتوحة بالكامل لجميع الشبكات السودانية. حماية معتمدة لمدة ١٢ شهرًا.",
  "home.phones.cta": "تصفح الآيفون",
  "home.acc.eyebrow": "الإكسسوارات",
  "home.acc.title": "الإكسسوارات",
  "home.acc.tag": "١٠٠٪ أصلية",
  "home.acc.desc": "أطقم شحن أصلية، سماعات، وحماية. لا نبيع قطع مفكوكة — فقط منتجات مغلفة من المصنع.",
  "home.acc.cta": "تصفح الإكسسوارات",
  "home.ess.eyebrow": "الأساسيات اليومية",
  "home.ess.title": "الأساسيات",
  "home.ess.tag": "أدوات العمل",
  "home.ess.desc": "أجهزة كمبيوتر محمولة، أجهزة لوحية، صوت وملحقات يومية للمحترفين والطلاب — معتمدة للاستخدام المحلي.",
  "home.ess.cta": "تصفح الأساسيات",
  "home.trust.provenance.title": "مصدر رسمي",
  "home.trust.provenance.desc": "مستوردة مباشرة من سلاسل التوزيع العالمية الرسمية منذ 2021.",
  "home.trust.warranty.title": "شروط الضمان",
  "home.trust.warranty.desc": "تغطية شاملة لمدة سنة على جميع الأجهزة، مع خدمة محلية في الخرطوم.",
  "home.trust.bilingual.title": "دعم ثنائي اللغة",
  "home.trust.bilingual.desc": "مساعدة فنية متخصصة متوفرة بالعربية والإنجليزية.",
  "home.trust.contact.title": "تفاصيل الاتصال",
  "home.trust.contact.desc": "زُرنا شخصيًا أو اتصل للحصول على تحديثات التوفر والتحقق من المواصفات.",
